...
export class LoginPage extends BasePage {
    ...
    constructor(page: Page) {
        ...
        this.passwordInput = this.page
            ...
            .or(this.page.locator("#id_password"))
            .first();
        this.loginButton = this.page
            .locator('input[type="submit"][value="Login"]')
            .or(this.page.locator('input[type="submit"][value="Log In"]'))
            .first();
    }
    ...
    async loginAsCandidate(email: string, password: string) {
